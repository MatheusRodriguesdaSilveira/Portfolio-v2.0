...
const ButtonCv = () => {
  return (
    <button
      type="submit"
      className="flex text-white justify-center gap-2 items-center mx-auto shadow-xl bg-zinc-900 isolation-auto border-brand before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-left-full before:hover:left-0 before:rounded-full before:bg-brand hover:text-zinc-900 before:-z-10 before:aspect-square before:hover:scale-150 before:hover:duration-700 relative z-10 px-4 py-2 overflow-hidden border-2 rounded-full group"
    >
      <a
