      ...
      <div className="flex flex-row xl:flex-col items-center gap-2 max-sm:flex-row max-sm:mb-5 text-white duration-300">
        <BlurFade delay={0.25 * 3.2} inView>
          <a
            ...
            target="_blank"
          >
            <AtSign className="hover:text-cyan-600 size-5 xl:size-4 2xl:size-5 max-sm:text-3xl duration-300 hover:scale-105" />
          </a>
        </BlurFade>
        <BlurFade delay={0.25 * 3.2} inView>
          <a
            ...
            target="_blank"
          >
            <FaWhatsapp className="hover:text-cyan-600 size-5 xl:size-4 2xl:size-5 max-sm:text-3xl duration-300 hover:scale-105" />
          </a>
        </BlurFade>
        <BlurFade delay={0.25 * 4.2} inView>
          <a
            ...
            target="_blank"
          >
            <GithubIcon className="hover:text-cyan-600 size-5 xl:size-4 2xl:size-5 max-sm:text-3xl duration-300 hover:scale-105" />
          </a>
        </BlurFade>
        <BlurFade delay={0.25 * 5.2} inView>
          <a
            ...
            target="_blank"
          >
            <Linkedin className="hover:text-cyan-600 size-5 xl:size-4 2xl:size-5 max-sm:text-3xl duration-300 hover:scale-105" />
          </a>
        </BlurFade>
      </div>
    </>
