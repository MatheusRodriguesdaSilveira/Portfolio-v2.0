      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center justify-center gap-5 mb-20">
        ...
        <BlurFade delay={0.25 * 4} inView>
          <div className="flex flex-col gap-2 items-center border border-zinc-500 rounded-xl xl:px-24 py-10 xl:py-14 2xl:py-14 shadow-lg shadow-indigo-500/40 hover:scale-95 hover:shadow-indigo-500/70 duration-500">
            ...
            <div className="grid grid-flow-col grid-rows-1 md:grid-rows-1 px-5 gap-2 xl:gap-4">
              <div className="flex flex-col items-center gap-1">
                <SiJavascript className="size-9 xl:size-10 text-yellow-500" />
                <p className="text-white text-xs font-semibold">JavaScript</p>
              </div>
              <div className="flex flex-col items-center gap-1">
                <FaReact className="size-9 xl:size-10 text-blue-700" />
                <p className="text-white text-xs font-semibold">React</p>
              </div>
              <div className="flex flex-col items-center gap-1">
                <SiNextdotjs className="size-9 xl:size-10 text-white" />
                <p className="text-white text-xs font-semibold">Next.Js</p>
              </div>
              <div className="flex flex-col items-center gap-1">
                <FaHtml5 className="size-9 xl:size-10 text-orange-500" />
                <p className="text-white text-xs font-semibold">Html</p>
              </div>
              <div className="flex flex-col items-center gap-1">
                <SiTailwindcss className="size-9 xl:size-10 text-sky-400" />
        ...
        <BlurFade delay={0.25 * 5} inView>
          <div className="flex flex-col gap-2 items-center border border-zinc-500 rounded-xl xl:px-24 py-10 xl:py-14 2xl:py-14 shadow-lg shadow-indigo-500/40 hover:scale-95 hover:shadow-indigo-500/70 duration-500">
            ...
            <div className="grid grid-flow-col grid-rows-2 md:grid-rows-1 gap-5 xl:gap-4">
              <div className="flex flex-col items-center gap-1">
                <SiNodedotjs className="size-9 xl:size-10 text-green-500" />
                <p className="text-white text-xs font-semibold">Node.Js</p>
              </div>
              <div className="flex flex-col items-center gap-1">
                <SiExpress className="size-9 xl:size-10 text-lime-600" />
                <p className="text-white text-xs font-semibold">Express</p>
              </div>
              <div className="flex flex-col items-center gap-1">
                <SiTypescript className="size-9 xl:size-10 text-blue-600" />
                <p className="text-white text-xs font-semibold">TypeScript</p>
              </div>
              <div className="flex flex-col items-center gap-1">
                <SiPrisma className="size-9 xl:size-10 text-cyan-900" />
                <p className="text-white text-xs font-semibold">Prisma</p>
              </div>
              <div className="flex flex-col items-center gap-1">
                <PiFileSqlBold className="size-9 xl:size-10 text-sky-500" />
                <p className="text-white text-xs font-semibold">SQL</p>
              </div>
              <div className="flex flex-col items-center gap-1">
                <SiPostgresql className="size-9 xl:size-10 text-sky-500" />
        ...
        <BlurFade delay={0.25 * 6} inView>
          <div className="flex flex-col gap-2 items-center border border-zinc-500 rounded-xl xl:px-24 py-10 xl:py-14 2xl:py-14 shadow-lg shadow-indigo-500/40 hover:scale-95 hover:shadow-indigo-500/70 duration-500">
            ...
            <div className="grid grid-flow-col grid-rows-2 md:grid-rows-1 gap-5 xl:gap-4">
              <div className="flex flex-col items-center gap-1">
                <FaGithub className="size-8 xl:size-10 text-purple-500" />
                <p className="text-white text-xs font-semibold">GitHub</p>
              </div>
              <div className="flex flex-col items-center gap-1">
                <FaGitAlt className="size-8 xl:size-10 text-orange-400" />
                <p className="text-white text-xs font-semibold">Git</p>
              </div>
              <div className="flex flex-col items-center gap-1">
                <Figma className="size-8 xl:size-10 text-pink-500" />
                <p className="text-white text-xs font-semibold">Figma</p>
              </div>
              <div className="flex flex-col items-center gap-1">
                <VscVscode className="size-8 xl:size-10 text-blue-500" />
                <p className="text-white text-xs font-semibold">VsCode</p>
              </div>
              <div className="flex flex-col items-center gap-1">
                <SiInsomnia className="size-8 xl:size-10 text-indigo-700" />
                <p className="text-white text-xs font-semibold">Insomnia</p>
              </div>
              <div className="flex flex-col items-center gap-1">
                <SiBeekeeperstudio className="size-8 xl:size-10 text-yellow-300" />
