...
const ShimmerButton = ({
  ...
  return (
    <motion.button
      ...
      className="relative inline-flex items-center justify-center p-0.5 overflow-hidden text-sm font-medium rounded-full group bg-gradient-to-br from-cyan-300 to-[#2803fc] text-white duration-300"
      whileTap={{ scale: 0.9 }}
    >
      {/* Efeito de brilho */}
      <motion.div
      ...
      <span className="group/button relative inline-flex h-12 w-12 xl:px-[26px] xl:py-[26px] md:h-[50px] md:w-[50px] lg:h-10 lg:w-10 items-center justify-center overflow-hidden ease-in bg-zinc-900 rounded-full group-hover:bg-opacity-0 duration-150 font-medium text-white hover:text-zinc-900 transition-all hover:w-[135px] xl:hover:w-[150px]">
        <span className="justify-center items-center flex">
          <a className="text-zinc-800 text-sm md:text-md font-bold flex ml-2 mb-0.5 gap-2 items-center whitespace-nowrap opacity-0 transition-all duration-150 group-hover/button:-translate-x-4 group-hover/button:opacity-100">
